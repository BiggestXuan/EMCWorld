...
public enum AdvancedUpdateRecipe implements IUpdateRecipe {
    ...
    ADVANCED_CONTROL(MekanismItems.ADVANCED_CONTROL_CIRCUIT.getItem(),MekanismItems.ELITE_CONTROL_CIRCUIT.getItem(),80000),
    ...
    ULTIMATE_CONTROL(MekanismItems.ELITE_CONTROL_CIRCUIT.getItem(),MekanismItems.ULTIMATE_CONTROL_CIRCUIT.getItem(),150000),
