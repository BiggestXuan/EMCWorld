...
public enum EMCOreRecipe {
    ...
    G1(EMCWorld.getItem("undergarden:cloggrum_ore"),5,6),
    G2(EMCWorld.getItem("undergarden:forgotten_ingot"),2,6),
    G3(EMCWorld.getItem("undergarden:utherium_ore"),5,6),
    G4(EMCWorld.getItem("aerialhell:fluorite_ore"),5,6),
    G5(EMCWorld.getItem("undergarden:regalium_ore"),5,6),
    G6(EMCWorld.getItem("gobber2:gobber2_ore_nether"),1,6),
    G7(EMCWorld.getItem("emcworld:indium_ore"),4,6),
    G8(EMCWorld.getItem("emcworld:tungsten_ore"),4,6),
    G9(EMCWorld.getItem("minecraft:ancient_debris"),1,6),
    H1(EMCWorld.getItem("mekanism:pellet_polonium"),6,7),
    H2(EMCWorld.getItem("mekanism:pellet_plutonium"),6,7),
