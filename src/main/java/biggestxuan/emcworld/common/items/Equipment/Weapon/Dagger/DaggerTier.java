...
public enum DaggerTier implements IDaggerTier {
    WOODEN(1.02,52,-2.4F,2f,0,1),
    STONE(1.05,104,-2F,3.25f,1,3),
    IRON(1.07,256,-1.8F,4.5f,2,8),
    GOLDEN(1.2,32,-0.8F,2.25f,0,20),
    DIAMOND(1.13,1541,-1.6F,5.25f,3,12),
    NETHERITE(1.15,2496,-1.4F,6f,4,16),
    GOD(1.05,2048,-2F,4.5f,4,15)
    ;
