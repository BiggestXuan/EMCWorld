...
import biggestxuan.emcworld.common.blocks.tile.GemstoneTileEntity;
import biggestxuan.emcworld.common.blocks.container.slot.GemstoneSlot;
import biggestxuan.emcworld.common.blocks.container.slot.GemWeaponSlot;
...
public class GemstoneContainer extends EMCWorldBaseContainer {
    ...
    public GemstoneContainer(int pContainerId, PlayerInventory inv, TileEntity blockEntity){
        ...
        this.addSlot(new GemWeaponSlot(tile.getInventory(),0,45,31));
