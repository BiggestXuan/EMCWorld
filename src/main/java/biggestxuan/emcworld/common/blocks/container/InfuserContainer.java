...
import biggestxuan.emcworld.common.blocks.container.slot.GemSlot;
import biggestxuan.emcworld.common.blocks.container.slot.ResultSlot;
...
public class InfuserContainer extends EMCWorldBaseContainer {
    ...
    public InfuserContainer(int pContainerId, PlayerInventory inv, TileEntity entity, IIntArray data) {
        ...
        tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler,0,43,6));
            this.addSlot(new SlotItemHandler(handler,1,15,29));
            this.addSlot(new GemSlot(handler,2,43,29));
            this.addSlot(new SlotItemHandler(handler,3,71,29));
            this.addSlot(new SlotItemHandler(handler,4,26,52));
            this.addSlot(new SlotItemHandler(handler,5,62,52));
            this.addSlot(new ResultSlot(handler,6,133,29));
        });
        addBar(inv);
