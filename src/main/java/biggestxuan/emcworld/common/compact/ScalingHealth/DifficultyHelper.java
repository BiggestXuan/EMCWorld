...
public class DifficultyHelper {
    public static double getPlayerDifficulty(PlayerEntity player){
    ...
    public static void addPlayerDifficulty(PlayerEntity player,double value){
        setPlayerDifficulty(player,Math.min(getPlayerDifficulty(player)+value,SHDifficulty.maxValue()));
    }
    public static void lossPlayerDifficulty(PlayerEntity player,double value){
        setPlayerDifficulty(player,Math.max(getPlayerDifficulty(player)-value,SHDifficulty.minValue()));
    }
