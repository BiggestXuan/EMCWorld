...
public enum DifficultySetting{
    eight("Eight",3000000.0,7000000.0,600000.0,800000.0,50000.0, 25000.0,500),
    seven("Seven",250000.0,1000000.0,75000.0,100000.0,13000.0, 7500.0,375),
    six("Six",32500.0,150000.0,14500.0,17000.0,2750.0, 1800.0,225),
    five("Five",3000.0,10000,1350.0,1985.0,168.5, 485.0,125),
    four("Four",420.0,775,255.5,345.5,26.5, 185.0,85),
    three("Three",45.0,85.5,25,62.5,3.5, 120.0,55),
    two("Two",6.0,12.0,4.5,8.0,0.65, 35.0,30),
