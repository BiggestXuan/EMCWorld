...
public enum DifficultySetting{
    eight("Eight",100000000.0,17000000.0,1000000.0,1800000.0,200000.0, 100000.0,500),
    seven("Seven",1700000.0,2000000.0,205000.0,200000.0,100000.0, 35000.0,375),
    six("Six",175000.0,250000.0,30500.0,27000.0,2400.5, 40000.0,225),
    five("Five",18000.0,15000,4550.0,2985.0,265.5, 12500.0,125),
    four("Four",2000.0,1775,850.0,450.5,35.5, 3500.0,85),
    three("Three",300.0,285.5,125,75.5,4.85, 1200.0,55),
    two("Two",25.0,24.0,12.5,10.5,0.65, 300.0,30),
    one("One",5.0,2.0,2.5,1.5,0.1, 60,20),
