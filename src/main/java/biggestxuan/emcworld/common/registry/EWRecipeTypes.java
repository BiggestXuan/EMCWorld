...
public class EWRecipeTypes {
    ...
    public static final RegistryObject<IRecipeSerializer<?>> ITEM_STAGE_LIMIT = RECIPES.register("item_stage_limit",() -> ItemStageLimit.ItemStageLimitSerializer.serializer);
