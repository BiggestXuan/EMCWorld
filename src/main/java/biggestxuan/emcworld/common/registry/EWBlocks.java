...
import biggestxuan.emcworld.common.blocks.GemstoneBlock;
...
import biggestxuan.emcworld.common.blocks.PrefixBlock;
import biggestxuan.emcworld.common.blocks.StarPedestalBlock;
import biggestxuan.emcworld.common.blocks.SteelFurnaceCore;
import biggestxuan.emcworld.common.blocks.SuperEMCBlock;
import biggestxuan.emcworld.common.blocks.TopCoreBlock;
import biggestxuan.emcworld.common.blocks.VisConversionBlock;
import biggestxuan.emcworld.common.blocks.WeaponUpgradeBlock;
...
public class EWBlocks {
        ...
        public static final RegistryObject<Block> TOP_CORE = BLOCKS.register("top_core", TopCoreBlock::new);
        public static final RegistryObject<Block> EMC_ORE_CORE = BLOCKS.register("emc_ore_core", EMCOreCoreBlock::new);
