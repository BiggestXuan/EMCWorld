...
public function modifyAstralRecipe() as void{
    ...
    extendedCraftingShapedRecipe([
	    ...
	    [a, <item:aerialhell:azurite_crystal>, <item:astralsorcery:ritual_link>, <item:astralsorcery:perk_gem_night>, <item:astralsorcery:ritual_link>, <item:aerialhell:azurite_crystal>, a], 
