...
public class Getter{
    var EMCWorldGems as ItemStack[]=[
        <item:emcworld:small_emc_gem>,
        <item:emcworld:big_emc_gem>,
        <item:emcworld:biggest_emc_gem>,
        <item:emcworld:advanced_emc_gem>,
        <item:emcworld:super_emc_gem>,
        <item:emcworld:epic_emc_gem>,
        <item:emcworld:infinity_emc_gem>
    ];

    var MCDyes as ItemStack[]=[
    ...
    var ProjectEMatter as ItemStack[]=[
    ...
    var BloodMagicslate as ItemStack[]=[
    ...
    var ProjectEXCollector as IItemStack[]=[
        ...
        <item:projectex:magenta_collector>,
        <item:projectex:pink_collector>,
        <item:projectex:purple_collector>,
        <item:projectex:violet_collector>,
        <item:projectex:blue_collector>,
        <item:projectex:cyan_collector>,
        <item:projectex:green_collector>,
        <item:projectex:lime_collector>,
        <item:projectex:yellow_collector>,
        <item:projectex:orange_collector>,
        <item:projectex:white_collector>,
        <item:projectex:fading_collector>,
        <item:projectex:final_collector>,
    ...
    var ProjectEXRelay as IItemStack[]=[
        ...
        <item:projectex:magenta_relay>,
        <item:projectex:pink_relay>,
        <item:projectex:purple_relay>,
        <item:projectex:violet_relay>,
        <item:projectex:blue_relay>,
        <item:projectex:cyan_relay>,
        <item:projectex:green_relay>,
        <item:projectex:lime_relay>,
        <item:projectex:yellow_relay>,
        <item:projectex:orange_relay>,
        <item:projectex:white_relay>,
        <item:projectex:fading_relay>,
        <item:projectex:final_relay>,
        <item:projecte:relay_mk1>,
        <item:projecte:relay_mk2>,
        <item:projecte:relay_mk3>
    ];

    var projectexHide as ItemStack[]=[
        <item:projectex:magenta_matter>,
        <item:projectex:pink_matter>,
        <item:projectex:purple_matter>,
        ...
        <item:projectex:yellow_matter>,
        <item:projectex:orange_matter>,
        <item:projectex:white_matter>,
        <item:projectex:fading_matter>,
        <item:projectex:dark_compressed_collector>,
        <item:projectex:red_compressed_collector>,
        <item:projectex:magenta_compressed_collector>,
        <item:projectex:pink_compressed_collector>,
        <item:projectex:purple_compressed_collector>,
        <item:projectex:violet_compressed_collector>,
        <item:projectex:blue_compressed_collector>,
        <item:projectex:cyan_compressed_collector>,
        <item:projectex:green_compressed_collector>,
        <item:projectex:lime_compressed_collector>,
        <item:projectex:yellow_compressed_collector>,
        <item:projectex:orange_compressed_collector>,
        <item:projectex:white_compressed_collector>,
    ...
    var projectexFlower as IItemStack[]=[
        ...
        <item:projectex:magenta_power_flower>,
        <item:projectex:pink_power_flower>,
        <item:projectex:purple_power_flower>,
        <item:projectex:violet_power_flower>,
        <item:projectex:blue_power_flower>,
        <item:projectex:cyan_power_flower>,
        <item:projectex:green_power_flower>,
        <item:projectex:lime_power_flower>,
        <item:projectex:yellow_power_flower>,
        <item:projectex:orange_power_flower>,
        <item:projectex:white_power_flower>,
        <item:projectex:fading_power_flower>,
    ...
    public getDye() as ItemStack[]{
        return this.MCDyes;
    }

    public getRune() as ItemStack[]{
        return this.BotaniaRunes;
    }

    public getMatter() as ItemStack[]{
        return this.ProjectEMatter;
    }

    public getShard() as ItemStack[]{
        return this.AtumShard;
    }
